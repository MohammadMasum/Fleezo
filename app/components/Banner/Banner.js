        ...
        <div className='container'>
          ...
          >
            <motion.div className="z-30 md:mb-0 mb-[30px] md:text-left text-center" variants={fadeInDown}>
              <h1 className="main-title md:mb-[15px] mb-[8px]"><span className="font-normal">Redefining</span> <span className="text-secondary">Restaurant</span> <span className="font-normal">Deliveries</span></h1>
